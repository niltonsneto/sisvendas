 ...
 * @author Neto
 */
public class CadTipo extends JPanel {
    ...
    private void initComponents() {
        ...
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT t FROM Tipo t");
    ...
    private class FormListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            if (evt.getSource() == saveButton) {
                CadTipo.this.saveButtonActionPerformed(evt);
            }
            else if (evt.getSource() == refreshButton) {
                CadTipo.this.refreshButtonActionPerformed(evt);
            }
            else if (evt.getSource() == newButton) {
                CadTipo.this.newButtonActionPerformed(evt);
            }
            else if (evt.getSource() == deleteButton) {
                CadTipo.this.deleteButtonActionPerformed(evt);
            }
        }
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<sisvendas.bean.admin.Tipo> toRemove = new ArrayList<sisvendas.bean.admin.Tipo>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            sisvendas.bean.admin.Tipo t = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(t);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        sisvendas.bean.admin.Tipo t = new sisvendas.bean.admin.Tipo();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<sisvendas.bean.admin.Tipo> merged = new ArrayList<sisvendas.bean.admin.Tipo>(list.size());
            for (sisvendas.bean.admin.Tipo t : list) {
    ...
    private java.util.List<sisvendas.bean.admin.Tipo> list;
    ...
    public static void main(final String[] args) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadTipo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                frame.setContentPane(new CadTipo());
